class MarkdownRenderer {
    constructor() {
      ...
      // Pre-built replacement templates
      this.replacements = {
    ...
    /**
     * Render markdown → HTML (fast path)
     */
    render(markdown) {
      let html = markdown
        // Code blocks (protect early)
        ...
        // Bold/Italic/Underline (specific → general)
      ...
      // Group consecutive <li> items into a <ul>
    ...
    /**
     * Load and render markdown from file
     */
